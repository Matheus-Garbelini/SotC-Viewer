...
enum Main {
  ...
  GL_MAX_OPTIMIZED_VERTEX_SHADER_INSTRUCTI=  0x87CA,
  GL_MAX_OPTIMIZED_VERTEX_SHADER_VARIANTS_=  0x87CB,
  GL_MAX_OPTIMIZED_VERTEX_SHADER_LOCAL_CON=T 0x87CC,
  GL_MAX_OPTIMIZED_VERTEX_SHADER_INVARIANT=  0x87CD,
  GL_MAX_OPTIMIZED_VERTEX_SHADER_LOCALS_EX=  0x87CE,
...
void glSetInvariantEXT( GLuint id, GLenum[Main] type, void *addr );
void glSetLocalConstantEXT( GLuint id, GLenum[Main] type, void *addr );
...
void glVariantPointerEXT( GLuint id, GLenum[Main] type, GLuint stride, void *addr );
